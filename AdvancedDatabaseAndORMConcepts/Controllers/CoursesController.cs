...
namespace AdvancedDatabaseAndORMConcepts_Lab3.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public CoursesController(AdvancedDatabaseAndORMConcepts_Lab3Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Course != null ? 
                          ...
                          Problem("Entity set 'AdvancedDatabaseAndORMConcepts_Lab3Context.Course'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AdvancedDatabaseAndORMConcepts_Lab3Context.Course'  is null.");
            }
            var course = await _context.Course.FindAsync(id);
            if (course != null)
            {
